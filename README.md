...
`node24` / `latest` currently resolve to **v24.14.1**. Example:

```sh
pkg-fetch --node-range node24.14.1 --platform linux --arch x64 --force-build --test
```
...
| 8<sup>[1](#fn1)</sup>, 10<sup>[1](#fn1)</sup>, 12<sup>[1](#fn1)</sup>, 14<sup>[1](#fn1)</sup>, 16<sup>[1](#fn1)</sup>, 18, 20, 24.14.1<sup>[4](#fn4)</sup> | linux       | x64                       | Enterprise Linux 7, Ubuntu 14.04, Debian jessie, other distros with glibc >= 2.17 |
...
<em id="fn4">[4]</em>: Patched as **v24.14.1**. Verified by building and packaging on Debian 12 (bookworm) / glibc, host Ubuntu 24.04.
